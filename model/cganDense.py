...
class CGAN():
    ...
    def load_xrays(self, epochs=100, batch_size=128, save_interval=50):
        (img_x, img_y) = 128,128
        ...
        for epoch in range(epochs):
            ...
            if len(exp_replay) == 1000:
                ...
                expprep_loss_gene = self.discriminator.train_on_batch([generated_images, labels], gene_labels)
                exp_replay = []
                break
            ...
            if epoch % save_interval == 0:
                self.generator.save("/Users/anushkagupta/Desktop/genny.h5")
    """""
...
if __name__ == '__main__':
    cgan = CGAN()
    cgan.load_xrays(epochs=500, batch_size=128, save_interval=50)
    cgan.generator.save('/Users/anushkagupta/Desktop/gen.h5')
    cgan.discriminator.save('/Users/anushkagupta/Desktop/disc.h5')
    ...
    for label in OHE_labels:
        for num in range(1000):
            ...
            #cnt+=1
            fig.savefig("/Users/anushkagupta/Desktop/imageconv/" + str(label) + "-" + str(num) + ".png")
            plt.clf()
